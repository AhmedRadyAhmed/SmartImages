...
namespace JamesApp
{
    class MyFile
    {
        public bool RenameFile(string curFile, string newName)
        {
            bool flag = false;
       ...
       public  string ChangeNames(string[] files, string path)
        {
        ...
        public void MoveFiles(string  fromDir, string toDir,Boolean isCopy=false )
        {
        ...
        public void MoveFile(string fromfile, string tofile, Boolean isCopy = false)
        {
        ...
        public void RemoveFiles(string _dir)
        {
        ...
        public string GetHtmlArt(string title, string artist, string size, string typemedia, string year, string conditionReport,string notes , string picurls, string weburl, DataTable tb)
        {
